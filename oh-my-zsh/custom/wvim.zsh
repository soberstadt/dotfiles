# from https://github.com/christoomey/dotfiles/blob/ea34518fa4d6a03d26d09998fa4486815a2305c0/zsh/configs/wvim.zsh
wvim() {
  command_name="$1"
...
_definition_field_for_pattern() {
  definition=$(grep -En "$2" ~/.zshrc ~/.oh-my-zsh/**/*.zsh 2>/dev/null)
